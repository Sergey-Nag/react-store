...
describe('LocalStorage user state', () => {
  ...
  describe('getLocalStoragetUser():', () => {
    it('Should return the user data from the local storage as object', () => {
      ...
      Object.setPrototypeOf(global.localStorage.getItem, jest.fn().mockReturnValue(stringifyUserObject));
    ...
    it('Should return null if user does not exist in the local storage', () => {
      jest.spyOn(Object.getPrototypeOf(global.localStorage), 'getItem')
      Object.setPrototypeOf(global.localStorage.getItem, jest.fn().mockReturnValue(null));
  ...
  describe('clearLocalStorageUser():', () => {
    it('Should clear user data from the local storage', () => {
      jest.spyOn(Object.getPrototypeOf(global.localStorage), 'removeItem')
      Object.setPrototypeOf(global.localStorage.removeItem, jest.fn());
